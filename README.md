...
- $k_B$ is the Boltzmann Constant, $k_B = 1.38 \cdot 10^{-23} J/K$ (Joules per Kelvin).

### 02-02-2025
**Yet to be completed**, but I have already set up the main page of the application,
as well as the equation and periodic table csv.
